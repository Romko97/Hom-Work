...
Розв’язки завдань. Розділ 18 49
...
50 Розв’язки завдань. Розділ 18
 self.game = game
 self.endgame = False
...
class MovingPlatformSprite(PlatformSprite):
 ...
 self.x *= -1
 self.counter = 0
Розв’язки завдань. Розділ 18 51
...
52 Розв’язки завдань. Розділ 18
...
Розв’язки завдань. Розділ 18 53
 def coords(self):
 xy = self.game.canvas.coords(self.image)
 self.coordinates.x1 = xy[0]
 self.coordinates.y1 = xy[1]
 ...
 co, sprite_co):
54 Розв’язки завдань. Розділ 18
